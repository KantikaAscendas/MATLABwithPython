...
2. Installing the AirQual Package

A. Change to the directory that contains the file setup.py and the subdirectory AirQual. 
...
3. Using the AirQual Package

The AirQual package is on your Python path. To import it into a Python script or session, 
execute:
